...
# set the path here
folder_path = "/GARCH Models in Python/"
setwd(folder_path)
# READ THE VIDEO FILE
...
for (i in 1:vilen) {
  ...
  new_video_name=str_replace_all(new_video_name, "[[:punct:]]", " ")
  new_video_name
...
# set the path here
folder_path = "Case Studies Manipulating Time Series Data in R/"
setwd(folder_path)
# READ THE VIDEO FILE
video_file=list.files(folder_path,pattern = ".mp4")
# test1=magick::image_read_video(file.choose())
...
# set the path here
folder_path = "Case Studies Network Analysis in R/"
setwd(folder_path)
# READ THE VIDEO FILE
video_file=list.files(folder_path,pattern = ".mp4")
# test1=magick::image_read_video(file.choose())
...
# set the path here
folder_path = "Case Study Exploratory Data Analysis in R/"
setwd(folder_path)
# READ THE VIDEO FILE
video_file=list.files(folder_path,pattern = ".mp4")
# test1=magick::image_read_video(file.choose())
